...
const schema = i.schema({
  entities: {
    ...
    profiles: i.entity({
      ...
      // Per-profile random salt (base64) for HKDF-based wallet key derivation.
      // Optional for backwards-compatibility with legacy profiles created
      // before security/hardening-pass-1.
